...
Example: find the critical value for a two-sided hypotheses test or confidence interval, where significance level or confidence level is 95% ($\alpha=0.05$)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyMTkyMTUyMyw5NjUxNzAyNjcsLTI3Nz
