...
SSR=\sum(\hat{y}_i-\bar{y})^2 \textrm{ , } \textit{df}_r=k \textrm{ , }  MSR=SSR/df\\
SST=\sum(y_i-\bar{y})^2 \textrm{ , } \textit{df}_t=n-1 \textrm{ , } MST=\frac{SST}{df}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5MDYyODQyNSwxNDY1MTE4NTY5LC04Mj
