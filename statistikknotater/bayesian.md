...
If $X$ is a discrete random variable with *pmf* $p(x;\theta)$, and $\theta$ is a continuous parameter, itself having *pdf* $f(\theta)$, then
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxMzg4OTAxNCwxNjQyNjYwMTIxLC0xNT
