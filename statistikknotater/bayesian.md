...
If $X$ is a random variable with *pmf* or *pdf* $p(x;\theta)$, where $\theta$ is a parameter given by the random variable $\Theta$, itself having *pmf* or *pdf* $f(\theta;\xi)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjUyODQyNDYsLTE2NjM0ODA2MzUsLT
