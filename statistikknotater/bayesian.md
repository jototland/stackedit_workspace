...
Often we are interested in determining $\theta$. In that case $f(\theta)$ is the *prior* and $f(\theta|x)$ is the *posterior*.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMjAwMTUyNSwtMTY2MzQ4MDYzNSwtMj
