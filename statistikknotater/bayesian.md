...
Since 
$$ p(\mu, \sigma^2)=p(\mu|\sigma^2)p(\sigma^2) $ we can write that

$$ (\mu, \phi) \sim \textrm{Normal}(m_0,\sigma^2/n_0)\,\textrm{Gamma}(v_0/2, v_0 s_0/2) $$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTk2ODQ3OTYxLDg3NzEzOTUyOCwtNTQwMD
