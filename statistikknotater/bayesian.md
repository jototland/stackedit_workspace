...
If our prior is that $X\sim\text{Binomial}(p)$, and we do not know $p$, but assume $p\sim\text{Beta}(\alpha,\beta)$, then even after we update our belief about $p$ 
Prior
: asdf

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0OTA2NzkxOCw3NTk4NTYyMTIsMTI0Nj
